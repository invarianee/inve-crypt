...
impl FieldElement2625x4 {
    ...
    fn reduce64(mut z: [u64x4; 10]) -> FieldElement2625x4 {
        ...
        let c = z[9] >> 25;
        z[9] = z[9] & LOW_25_BITS;
        let mut c0: u64x4 = c & LOW_26_BITS;
        let mut c1: u64x4 = c >> 26;

        unsafe {
            use core::arch::x86_64::_mm256_mul_epu32;
            let x19 = u64x4::splat(19);
            c0 = _mm256_mul_epu32(c0.into_bits(), x19.into_bits()).into_bits();
            c1 = _mm256_mul_epu32(c1.into_bits(), x19.into_bits()).into_bits();
        }
